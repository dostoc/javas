...
public class MesesServicio {
    ...
    Meses puente= new Meses();
    
    public void advinaMes(){
        System.out.println("ADIVINE!: Escriba un mes del año");
        System.out.println("*"+puente.getMesX()+"*");
        do {
            String respuesta = leer.next().toLowerCase();
            if (respuesta.equals(puente.getMesX())){
